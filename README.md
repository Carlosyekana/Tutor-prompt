...
- **1.11.1** — Corregida la contradicción entre la regla dura de confirmar la herramienta objetivo y la sección "Herramienta desconocida", que mandaban cosas distintas sin decir cuál ganaba. Ahora se distinguen dos casos: herramienta no nombrada (la regla dura manda preguntar) y herramienta nombrada pero sin ficha en el catálogo de perfiles (se construye con el perfil más cercano, sin preguntar, declarándolo en la nota de preparación).
